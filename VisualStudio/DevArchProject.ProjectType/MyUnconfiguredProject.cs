...
namespace DevArchProject
{
    ...
    [ProjectTypeRegistration(VsPackage.ProjectTypeGuid, "DevArch", "#2", ProjectExtension, Language, resourcePackageGuid: VsPackage.PackageGuid, PossibleProjectExtensions = ProjectExtension, ProjectTemplatesDir = @"..\..\Templates\Projects\MyCustomProject")]
    ...
    internal class MyUnconfiguredProject
    {
        ...
        /// </summary>
        internal const string ProjectExtension = "archproj";
        ...
        /// </remarks>
        internal const string UniqueCapability = "DevArchProject";

        internal const string Language = "DevArchProject";
