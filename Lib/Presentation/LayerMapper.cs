    ...
    public static class LayerMapper
    {
            ...
            IColorData parentColorData = null,LayerViewModel parent = null)
        {
            ...
            if (toPaintDistinct.Count > 1)
                distinctColors = new Stack<IColorData>(Pallette.GetDistinctColors(parentColorData,toPaintDistinct.Count));
            if(toPaintDistinct.Count == 1)
        ...
        private static void PaintLayer(LayerViewModel layer, IColorData colorData)
        {
